...
if [ "$RANK" -eq 0 ]; then
    ...
    ray start --head   --port=8443   --node-ip-address=10.8.0.1   --dashboard-host=0.0.0.0   --dashboard-port=8266 --redis-password=Noematrix_tmp123!
    ...
    # ray start --memory=461708984320 --address="$HEAD_ADDRESS:$RAY_PORT"
     ray start --memory=10737418240 --address=10.8.0.1 --node-ip-address=10.8.0.4  --redis-password=Noematrix_tmp123! --block
fi